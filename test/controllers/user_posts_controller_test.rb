...
class UserPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_post" do
    assert_difference('UserPost.count') do
      post user_posts_url, params: { user_post: { body: @user_post.body, title: @user_post.title } }
    end
  ...
  test "should update user_post" do
    patch user_post_url(@user_post), params: { user_post: { body: @user_post.body, title: @user_post.title } }
